...
namespace CaltureDepartment.Data.Repositories
{
    public class WorkerRepository : IWorkerRepository
    {
        ...
        public Worker GetWorker(int id)=> _context.Workers.Find(w => w.Id == id);
        public void AddWorker(Worker w)=> _context.Workers.Add(w);
        public bool UpdateWorker(int id, Worker w)
        {
            var worker = _context.Workers.Find(e => e.Id == id);
            if (worker != null)
            {
                worker.TZ = w.TZ;
        ...
        public void DeleteWorker(int id)=> _context.Workers.Remove(_context.Workers.Find(w => w.Id == id));
    }
}
